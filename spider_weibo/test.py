...
def test():
    ...
    url = "https://wx1.sinaimg.cn/wap180/001P0DUIgy1i0ph9xf3vuj621w2yonpg02.jpg"
    url = "https://weibo.com/ajax/side/search?q=Dear-迪丽热巴"
    response = requests.get(url, headers=headers)
    print(response.json().get("data").get("user"))
    # with open('./../data/sina_weibo/image_u03.jpg', 'wb') as f:
